...
// ** SETUP **
// Assign the FirstPersonCharacterController object to its own Layer
// Assign the Layer Mask to ignore the FirstPersonCharacterController object Layer
...
// alternatively : 
// at the end of this script is a Menu Item function to create and auto-configure a FirstPersonCharacterController object
// GameObject -> 3D Object -> FirstPersonCharacterController
...
public class FirstPersonCharacterController : MonoBehaviour
{
    ...
    public Transform cameraTx;                                 // Main Camera, as child of FirstPersonCharacterController object
    ...
    void Initialize()
    {
        if (!cameraTx) { Debug.LogError("* " + gameObject.name + ": FirstPersonCharacterController has NO CAMERA ASSIGNED in the Inspector *"); }
...
// this section adds create FirstPersonCharacterController object to the menu : New -> GameObject -> 3D Object
...
public class FirstPersonCharacterController_Setup : MonoBehaviour
{
#if UNITY_EDITOR

    private static int playerLayer = 2; // default to the Ignore Raycast Layer (to demonstrate configuration)

    [MenuItem("GameObject/3D Object/FirstPersonCharacterController", false, 0)]
    public static void CreateFirstPersonCharacterController()
    {
        ...
        FirstPersonCharacterController firstPersonCharacterController = go.AddComponent<FirstPersonCharacterController>();

        // Layer Mask
        go.layer = playerLayer;
        firstPersonCharacterController.castingMask = ~(1 << playerLayer);
        Debug.LogError("** SET the LAYER of the PLAYER Object, and the LAYERMASK of the FirstPersonCharacterController castingMask **");
        Debug.LogWarning(
            "Assign the FirstPersonCharacterController Player object to its own Layer, then assign the Layer Mask to ignore the FirstPersonCharacterController Player object Layer. Currently using layer "
        ...
        if (mainCamObject)
        {
            ...
            firstPersonCharacterController.cameraTx = mainCamObject.transform;
        }
        else // create example camera
        {
            ...
            GameObject camGo = new GameObject("FirstPersonCharacterController Camera");
            ...
            firstPersonCharacterController.cameraTx = camGo.transform;
        }
        ...
        firstPersonCharacterController.playerGFX = gfx.transform;
    }
#endif
}
